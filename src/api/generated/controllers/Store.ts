...
export class StoreService {
  ...
  placeOrder(params: PlaceOrderParams): Observable<__model.Order> {
    ...
    return this.http.post<__model.Order>(`/v2/store/order`, bodyParams || {});
  }
  ...
  getOrderById(params: GetOrderByIdParams): Observable<__model.Order> {
    ...
    return this.http.get<__model.Order>(`/v2/store/order/${pathParams.orderId}`);
  }
  ...
  deleteOrder(params: DeleteOrderParams): Observable<void> {
    ...
    return this.http.delete<void>(`/v2/store/order/${pathParams.orderId}`);
  }
  ...
  inventory(): Observable<[key: string]: number;> {
    return this.http.get<[key: string]: number;>(`/v2/store/inventory`);
  }
}
